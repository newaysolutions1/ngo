...
export default function TiltCard({ bg, title, subtitle, badge, onTour }) {
  ...
  return (
    <div
      ...
      className="relative block w-full max-w-[380px] aspect-[9/15.5] rounded-[1.75rem] overflow-hidden cursor-grab bg-cover bg-center shadow-[0_0_0_2px_rgba(0,210,132,0.45),0_0_25px_8px_rgba(0,210,132,0.20)] transition-transform duration-[600ms] ease-[cubic-bezier(.23,1,.32,1)] will-change-transform"
    >
      {/* emerald rim */}
      <div
      ...
      {/* gradient (unchanged) */}
      <div
        className="absolute bottom-0 inset-x-0 h-[75%] bg-gradient-to-t from-[rgba(10,10,10,0.9)] via-[rgba(10,10,10,0.65)] to-transparent pointer-events-none z-10 will-change-transform"
        data-tilt-transform-element
      />
      ...
      >
        ...
        <button
          onClick={onTour}
          className="mt-4 inline-flex items-center justify-center gap-2 rounded-full px-7 py-3 font-semibold shadow-[inset_2px_2px_4px_rgba(0,107,82,.6),inset_-2px_-2px_4px_rgba(200,255,235,.5),0_1px_2px_rgba(0,0,0,.1)] transition-all will-change-transform"
          style={{
